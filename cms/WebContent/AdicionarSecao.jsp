...
function verif(){
	if(document.getElementById('statusSecao').value.length==1){
...
<title>Cadastro de Se&ccedil;&atilde;o</title>
<link href="css/style.css" rel="stylesheet" type="text/css" />
</head>
<body onload="focar();">
	<!-- header -->
<form name="submit" action="AdicionarSecaoNoBanco.action" method="post" onsubmit="return validaCampos();">
  ...
  <div id="menu" class="menu">
        	<ul>
			  <li><a href="ExibirSecaoPagina.action">Voltar</a></li>
           </ul>
      </div>
    <!--end header -->
    <!-- main -->
      ...
      <div id="content_body" class="content_body">
            ...
            <div id="text_body" class="text_body">
                <table border="0" style="width: 100%;">
					<tr>
						<td colspan="3" align="Center"><h3>Cadastro de Se&ccedil;&atilde;o</h3></td>
					</tr>
					...
					<tr>
						<td width="10%">Nome Se&ccedil;&atilde;o:</td>
						<td colspan="2"><input id="nomeSecao" type="text" name="nomeSecao" size="40" maxlength="100"></td>
					</tr>

					<tr>
						<td>Status Se&ccedil;&atilde;o:</td>
						<td colspan="2"><input id="statusSecao" type="text" name="statusSecao" size="40" maxlength="1" onkeypress="verif();"></td>
					</tr>
