...
<body>
  ...
  <div id="menu" class="menu">
        	<ul>
              <li><a href="ExibirTopicosUsuario.action">T&oacute;picos</a></li>
			  <li><a href="ExibirItemTopicoUsuario.action">Item T&oacute;pico</a></li>
			  <li><a href="ExibirSecaoUsuario.action">Se&ccedil;&atilde;o</a></li>
			  <li><a href="Inicial.action">Sair</a></li>
          </ul>
      </div>
    <!--end header -->
    <!-- main -->
    <div id="content" class="content">
      ...
      <div id="content_body" class="content_body">
            ...
            <div id="sidebar_body" class="sidebar_body" align="center">Aluno</div>
            ...
            <div id="text_body" class="text_body">
               Sistema de gerenciamento de conte&uacute;do, software simples para gerenciar alguma coisa sobre algo de JAVA. <br> -Para visualizar os conte&uacute;dos, clique em um dos menus acima             
