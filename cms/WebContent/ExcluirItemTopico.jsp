...
<title>Excluir Item T&oacute;pico</title>
<link href="css/style.css" rel="stylesheet" type="text/css" />
</head>
<body onload="focar();">
	<!-- header -->
<form name="submit" action="ExcluirItemTopicoNoBanco.action" method="post" onsubmit="return validaCampos();">
      ...
      <div id="content_body" class="content_body">
            ...
            <div id="text_body" class="text_body">
                <table border="0" style="width: 100%;">
					<tr>
						<td colspan="3" align="Center"><h3>Exclus&atilde;o de Item T&oacute;pico</h3></td>
					</tr>					

					<tr>
						<td width="10%">N&uacute;mero do Item T&oacute;pico:</td>
						<td colspan="2"><input id="numItemTopico" type="text" name="numItemTopico" size="40" onKeyDown="Mascara(this,Integer);" onKeyPress="Mascara(this,Integer);" onKeyUp="Mascara(this,Integer);"></td>
					</tr>
