				...
				<div id="text_body" class="text_body">
					<table border="0" style="width: 100%;">
						<tr>
							...
							<td colspan="2">
								<input id="campoUsuario" type="text" name="campoUsuario" size="20">
							</td>
							<td>&nbsp;</td>
							<td align="center">
							...
							<td>
								<input id="campoSenha" type="password" name="campoSenha" size="20">
							</td>
							<td align="right"><button  type="submit" class="entrar">Entrar</button></td>
						</tr>
					</table>
				</div>
