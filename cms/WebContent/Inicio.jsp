    ...
    <div id="content" class="content">
		...
		<div id="content_body" class="content_body">
		 	<div id="sidebar" class="sidebar">
				...
				<div id="sidebar_body" class="sidebar_body">&nbsp;</div>
            ...
            <div id="text" class="text">
				...
				<div id="text_body" class="text_body">
					<table border="0" style="width: 100%;">
						<tr>
							<form name="submit" action="ExibirAdministrador.action" method="post" >
							<td align="center" colspan="2">
								<button name="administrador" type="submit" class="botao">Administrador</button>
							</td>
							</form>
							<td>&nbsp;</td>
							<form name="submit" action="ExibirUsuario.action" method="post" >
							<td align="center">
								<button name="usuario" type="submit" class="botao">Usuário</button>
							</td>
							</form>
						</tr>
					</table>
