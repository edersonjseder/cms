...
<title>P&aacute;gina Usu&aacute;rios</title>
...
<body>
  ...
  <div id="menu" class="menu">
        	<ul>
			  <li><a href="AdicionarUsuarios.action">Adicionar Usu&aacute;rios</a></li>
			  <li><a href="ExcluirUsuarios.action">Excluir Usu&aacute;rios</a></li>
    ...
    <div id="content" class="content">
      ...
      <div id="content_body" class="content_body">
            ...
            <div id="text_body" class="text_body">
                <display:table name="listaAdministrador" id="listaAdministrador" requestURI="ExibirUsuarios.action"
					class="table_lista" style="width: 100%">		
				
				
				<display:column property="usuario"  titleKey="Nome Usuario" class="list_center" style="width: 25%;" />
				<display:column property="email"  titleKey="E-mail" class="list_center" style="width: 22%;" />
