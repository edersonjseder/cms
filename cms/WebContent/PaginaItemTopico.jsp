...
<title>P&aacute;gina Item T&oacute;pico</title>
...
<body>
  ...
  <div id="menu" class="menu">
        	<ul>
              <li><a href="AdicionarItemTopico.action">Adicionar Item T&oacute;picos</a></li>
			  <li><a href="ExcluirItemTopico.action">Excluir Item T&oacute;picos</a></li>
    ...
    <div id="content" class="content">
      ...
      <div id="content_body" class="content_body">
            ...
            <div id="text_body" class="text_body">
                <display:table name="listaItemTopico" id="listaItemTopico" requestURI="ExibirItemTopico.action"
					class="table_lista" style="width: 100%">		
				
				<display:column property="idItemTopico"  titleKey="Nome Item Topico" class="list_center" style="width: 25%;" />
				<display:column property="nome"  titleKey="Nome Item Topico" class="list_center" style="width: 25%;" />
				<display:column property="descricao"  titleKey="Descricao" class="list_center" style="width: 25%;" />
