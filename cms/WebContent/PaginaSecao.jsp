...
<title>P&aacute;gina Se&ccedil;&atilde;o</title>
...
<body>
  ...
  <div id="menu" class="menu">
        	<ul>
			  <li><a href="AdicionarSecao.action">Adicionar Se&ccedil;&atilde;o</a></li>
			  <li><a href="ExcluirSecao.action">Excluir Se&ccedil;&atilde;o</a></li>
    ...
    <div id="content" class="content">
      ...
      <div id="content_body" class="content_body">
            ...
            <div id="text_body" class="text_body">
                <display:table name="listaSecao" id="listaSecao" requestURI="ExibirSecao.action"
					class="table_lista" style="width: 100%">		
				
				
				<display:column property="nome"  titleKey="Nome Secao" class="list_center" style="width: 25%;" />
