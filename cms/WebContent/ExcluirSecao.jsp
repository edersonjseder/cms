...
<title>Excluir Se&ccedil;&atilde;o</title>
<link href="css/style.css" rel="stylesheet" type="text/css" />
</head>
<body onload="focar();">
	<!-- header -->
<form name="submit" action="ExcluirSecaoNoBanco.action" method="post" onsubmit="return validaCampos();">
      ...
      <div id="content_body" class="content_body">
            ...
            <div id="text_body" class="text_body">
                <table border="0" style="width: 100%;">
					<tr>
						<td colspan="3" align="Center"><h3>Exclus&atilde;o de Se&ccedil;&atilde;o</h3></td>
					</tr>					

					<tr>
						<td width="10%">N&uacute;mero da Se&ccedil;&atilde;o:</td>
						<td colspan="2"><input id="numSecao" type="text" name="numSecao" size="40" onKeyDown="Mascara(this,Integer);" onKeyPress="Mascara(this,Integer);" onKeyUp="Mascara(this,Integer);"></td>
					</tr>
