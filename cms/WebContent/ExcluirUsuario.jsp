...
<title>Excluir Usu&aacute;rios</title>
<link href="css/style.css" rel="stylesheet" type="text/css" />
</head>
<body onload="focar();">
	<!-- header -->
<form name="submit" action="ExcluirUsuariosNoBanco.action" method="post" onsubmit="return top.checaEmail(document.forms[0]);">
      ...
      <div id="content_body" class="content_body">
            ...
            <div id="text_body" class="text_body">
                <table border="0" style="width: 100%;">
					<tr>
						<td colspan="3" align="Center"><h3>Exclus&atilde;o de Usu&aacute;rios</h3></td>
					</tr>					
					...
					<tr>
						<td colspan="3" align="right"><button  type="submit" id="entrar" class="entrar">Excluir</button></td>
					</tr>
				</table>
