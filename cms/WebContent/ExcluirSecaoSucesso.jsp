...
<title>Exclus&acute;o de Se&ccedil;&atilde;o</title>
...
<body>
  ...
  <div id="menu" class="menu">
        	<ul>
			  ...
			  <li><a href="ExcluirSecao.action">Voltar</a></li>
           </ul>
      </div>
    <!--end header -->
    <!-- main -->
      ...
      <div id="content_body" class="content_body">
            ...
            <div id="text_body" class="text_body">
                <table border="0" style="width: 100%;">
					<tr>
						<td colspan="3" align="Center"><h1>Se&ccedil;&atilde;o Exclu&iacute;da com Sucesso!!!</h1></td>
					</tr>					
				</table>
